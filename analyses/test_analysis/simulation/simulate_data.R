...
sonde_data = read_csv("analyses/test_analysis/model_fit/input/sonde_prep.csv")
model_fit = read_csv("analyses/test_analysis/model_fit/output/sig_obs10/summary_clean.csv")
