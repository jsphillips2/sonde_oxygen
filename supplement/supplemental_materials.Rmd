...
Raw data and code for cleaning, processing, and filter data can be found at [will link to GitHub].
...
Detailed explanation of code for specifying, fitting, and diagnosing the model with Stan can be found at [will link to GitHub].
...
Detailed explanation of code for simulated data and corresponding model fit with Stan can be found at [will link to GitHub]. 
